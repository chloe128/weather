...
async function getWeather(cityName) {
    try {
        const response = await (0, _axiosDefault.default).get(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=${api_key}`);
        ...
        temperature.innerHTML = `${Math.round(cityData.main.temp - 273.15)}\xb0C`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequirebbde")
